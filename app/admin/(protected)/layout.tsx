    ...
    <div>
      <header className="flex flex-wrap items-center justify-between gap-3 border-b border-ink-15 px-4 py-4 sm:px-8 sm:py-5 lg:px-12 lg:py-6">
        <nav className="flex flex-wrap items-center gap-6 lg:gap-8">
          <Link href="/admin/dashboard" aria-label="Ordrfy — home" className="flex items-center gap-2.5">
          ...
          <Link href="/admin/dashboard" className="font-app text-base text-ink-70 hover:text-ink lg:text-lg">
            Dashboard
          </Link>
